...
class InvarLayer(nn.Module):
    def __init__(self, in_channels, out_channels, stride=1):
        ...
        self.conv = torch.nn.Conv2d(6 * in_channels - 1, out_channels, kernel_size=1)
...
class InvarLayer_RS_cnn(nn.Module):
    def __init__(self, C1=67, C2=132, C3=199):
        super().__init__()
