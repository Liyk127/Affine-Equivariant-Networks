...
class InvarPDEs_Net_scale(torch.nn.Module):
    def __init__(self, num_class=10, channel=65, hidden_channel=65, iter=16):
        super(InvarPDEs_Net_scale, self).__init__()
        ...
        learnable_step = torch.tensor([1/self.iter]*self.iter, requires_grad=True)
